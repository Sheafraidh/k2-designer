...
class Project:
    ...
    def __init__(self, name: str = "Untitled Project", description: str | None = None,
        ...
        self.last_active_diagram: str | None = None
    ...
    def get_owner(self, owner_name: str) -> Owner | None:
    ...
    def get_table(self, table_name: str, owner_name: str) -> Table | None:
    ...
    def get_sequence(self, sequence_name: str, owner_name: str) -> Sequence | None:
    ...
    def get_diagram(self, diagram_name: str) -> Diagram | None:
    ...
    def get_active_diagram(self) -> Diagram | None:
    ...
    def get_stereotype(self, stereotype_name: str) -> Stereotype | None:
