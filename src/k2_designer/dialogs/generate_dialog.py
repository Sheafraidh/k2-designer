...
class SqlGeneratorWorker(QThread):
    ...
    def run(self):
        ...
        try:
            self.log_message.emit("🚀 Starting SQL generation...")
            ...
            self.log_message.emit("✅ SQL generation completed successfully!")
            self.finished.emit()
    ...
    def _generate_single_file(self):
        ...
        self.log_message.emit(f"📄 Generating single file: {self.single_filename}")
        ...
        try:
            ...
            self.log_message.emit(f"✅ Generated: {self.single_filename}")
    ...
    def _generate_table_sql(self, table):
        ...
        try:
            ...
            self.log_message.emit(f"📄 Generated: {filename}")
