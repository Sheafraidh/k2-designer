...
class DiagramConnection:
    ...
    label: str | None = None  # Optional label for the connection
    guid: str = field(default_factory=lambda: str(uuid.uuid4()))
...
class Diagram:
    ...
    def __init__(self, name: str, description: str = "", guid: str | None = None):
        self.name = name
    ...
    def get_item(self, object_name: str) -> DiagramItem | None:
    ...
    def add_connection(self, source_table: str, target_table: str,
                      connection_type: str = 'manual', label: str | None = None):
